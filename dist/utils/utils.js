...
exports.createUserSchema = joi_1.default.object().keys({
    ...
    confirmPassword: joi_1.default.any().equal(joi_1.default.ref('password')).required().label('Confirm password')
...
exports.addBankSchema = joi_1.default.object().keys({
    ...
    accountNumber: joi_1.default.string().length(10).regex(/^[0-9]*$/).required()
        .messages({
...
exports.addTransactionSchema = joi_1.default.object().keys({
    ...
    destinationPhoneNumber: joi_1.default.string().length(11).pattern(/^[0-9]+$/).required()
});
